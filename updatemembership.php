                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        <div class="form-group">
                            ...
                            <option value="New-Prospect"<?php if ($_GET['User_status_Current'] == 'New-Prospect') { echo 'selected'; } ?>>New-Prospect</option>
								<option value="Considering"<?php if ($_GET['User_status_Current'] == 'Considering') { echo 'selected'; } ?>>Considering</option>
								<option value="Declined"<?php if ($_GET['User_status_Current'] == 'Declined') { echo 'selected'; } ?>>Declined</option>
								<option value="Member"<?php if ($_GET['User_status_Current'] == 'Member') { echo 'selected'; } ?>>Member</option>
								<option value="Withdrawn"<?php if ($_GET['User_status_Current'] == 'Withdrawn') { echo 'selected'; } ?>>Withdrawn</option>
								</select>
                        </div>
