    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        if(mysqli_stmt_execute($stmt)){
            ...
            if(mysqli_num_rows($result) == 1){
				...
				$User_Position_TerminationDate			= $row["User_Position_TerminationDate"]; 
...
<a class=active href="Profile.php?id=<?php echo htmlspecialchars($_SESSION["id"]); ?>" title="Profile">Profile</a>
...
<br>Your username is: <?php echo htmlspecialchars($_SESSION["username"]); ?>
    ...
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="mt-5 mb-3">View Employee Details:</h1>
                    <div class="form-group">
					
								<table style="width:auto" class="table table-bordered table-striped center">
                               
                                 
                                        <?php echo "<tr><th>Username:</th><td>";?><?php echo $row["User_id"]; ?>
                                        <?php echo "</td></tr><tr><th>First Name:</th><td>";?><?php echo $row["User_Name_First"]; ?>
                                        <?php echo "</td></tr><tr><th>Last Name:</th><td>";?><?php echo $row["User_Name_Last"]; ?>
                                        <?php echo "</td></tr><tr><th>State Title:</th><td>";?><?php echo $row["User_Position_State"]; ?>
                                        <?php echo "</td></tr><tr><th>SSU Position Title:</th><td>";?><?php echo $row["User_Position_SSU"]; ?>
										<?php echo "</td></tr><tr><th>Is Contract:</th><td>";?><?php echo $row["User_Position_IsContract"]; ?>
										<?php echo "</td></tr><tr><th>Hire Date:</th><td>";?><?php echo $row["User_Position_HireDate"]; ?>
										<?php echo "</td></tr><tr><th>Termination Date:</th><td>";?><?php echo $row["User_Position_TerminationDate"]; ?>
										<?php echo "</td></tr><tr><th>Funding:</th><td>";?><?php echo $row["User_Position_Funding"]; ?>
										<?php echo "</td></tr><tr><th>Salary:</th><td>";?><?php echo $row["User_Position_Salary"]; ?>                                    
										<?php echo "</td></tr><tr><th>Ethnicity:</th><td>";?><?php echo $row["User_Ethnicity"]; ?>  
										<?php echo "</td></tr><tr><th>Birth Month:</th><td>";?><?php echo $row["User_BirthMonth"]; ?>  
										<?php echo "</td></tr><tr><th>Birth Year:</th><td>";?><?php echo $row["User_BirthYear"]; ?>  										
										<?php echo "</td></tr><tr><th>Education Level:</th><td>";?><?php echo $row["User_EdLevel"]; ?>  
										<?php echo "</td></tr><tr><th>MTANumber:</th><td>";?><?php echo $row["User_MTANumber"]; ?>  
										<?php echo "</td></tr><tr><th>Effective Date:</th><td>";?><?php echo $row["User_Effdt"]; ?>  
								</td>
								</tr>
								</table>
