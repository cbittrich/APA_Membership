							...
							echo '<table style="width:auto" class="table table-bordered table-striped center">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo '<a href="viewmembership.php?id='. $row['Id'] .'" class="mr-3" title="View Membership Status" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                                            echo '<a href="updatemembership.php?id='. $row['Id'] .'" class="mr-3" title="Update Membership Status" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                            echo '<a href="terminatemembership.php?id='. $row['Id'] .'" class="mr-3" title="Terminate Membership" data-toggle="tooltip"><span class="fa fa-archive"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
