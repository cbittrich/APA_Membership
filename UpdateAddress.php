    ...
    if(empty($Address_Street1_err) && empty($Address_Street2_err) && empty($Address_City_err) && empty($Address_Zip_err) && empty($Address_State_err) && empty($Address_Email_err)){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                header("location: ViewMembershipAddress.php");
                exit();
            } else{
...
<head>
    <meta charset="UTF-8">
    <title>APA - Update Member Address</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <style>
        .wrapper{
            width: 600px;
...
<body>
    ...
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5">Update Member Address: <?php echo $User_Name_First; ?>  <?php echo $User_Name_Last; ?></h2>
                    <p>Please complete the required address information for the member.</p>
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        <div class="form-group">
                            <label>Address_Street1:</label>
                        ...
                        <a href="ViewMembershipAddress.php" class="btn btn-secondary ml-2">Cancel</a>
                    </form>
                </div>
            </div>        
        </div>
