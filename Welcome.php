...
<!--<div class="layout-container">
  ...
  <h2 class="visually-hidden" id="block-rtf-main-menu-menu">Member Services</h2>
  

        
              <ul class="menu">
                    <li class="menu-item">
        <a href="viewmembershipstatus.php?id=<?php echo htmlspecialchars($_SESSION["id"]); ?>"  class="is-active">View Membership Status</a>
              </li>  
                <li class="menu-item">
		<a href="Profile.php?id=<?php echo htmlspecialchars($_SESSION["id"]); ?>">View Employee Information</a>             
			 </li>
			        <li class="menu-item">
        <a href="Update_AddressNew.html" title="Update Address">Update Address Information</a>
