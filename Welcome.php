...
<br>Your username is: <?php echo htmlspecialchars($_SESSION["username"]); ?>
	 ...
	 <br>
		...
		<table style="width:auto" class="center">
                <tr><td><li>
        <a href="viewmembershipstatus.php?id=<?php echo htmlspecialchars($_SESSION["id"]); ?>"title="View Membership Status">View Membership Status</a>
              </li></td></tr> 
                <tr><td><li> 
		<a href="Profile.php?id=<?php echo htmlspecialchars($_SESSION["id"]); ?>"title="View Employee Record">View Employee Record</a>             
			 </li></td></tr>
			        <tr><td><li> 
        <a href="UpdateAddressSelf.php?id=<?php echo htmlspecialchars($_SESSION["id"]); ?>" title="Update Address">Update Address</a>
  
              </li></td></tr>
			  			        <tr><td><li>
        <a href="change-password.php?id=<?php echo htmlspecialchars($_SESSION["id"]); ?>" title="Change Password">Change Password</a>
