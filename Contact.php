...
<!DOCTYPE html>
<title>APA - Contact</title>
	<div class="topnav">
	<?php if (empty($_SESSION["IsAdmin"])) {

} else
{
echo "<a href=WelcomeAdmin.php title='Admin'>Admin</a>";
}; ?>
<a href="Welcome.php" title="Home">Home</a>
<a href="Profile.php?id=<?php echo htmlspecialchars($_SESSION["id"]); ?>" title="Profile">Profile</a>
<a class=active href="Contact.php"title="Contact">Contact</a>
...
<iframe src="https://ssuapa.org/officers/" width="100%" height="700" title="SSU APA Officers">
</iframe>
