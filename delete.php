                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            ...
                            <p>Are you sure you want to delete this record? <b>This should only be done to accounts created in error</b></p>
                            <p>
                                <input type="submit" value="Yes" class="btn btn-danger">
                                <a href="ViewEmployeeRoster.php" class="btn btn-secondary">No</a>
                            </p>
                        </div>
                    </form>
                </div>
