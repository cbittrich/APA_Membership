					...
					<?php echo '<table class="table table-bordered table-striped">';?>
                                <?php echo "<thead>";?>
                                    <?php echo "<tr>";?>
                                        ...
                                        <?php echo "</td></tr><tr><th>Name_First:</th><td>";?><?php echo $row["User_Name_First"]; ?>
                                        <?php echo "</td></tr><tr><th>Name_Last:</th><td>";?><?php echo $row["User_Name_Last"]; ?>
										...
										<?php echo "</td></tr><tr><th>HireDate:</th><td>";?><?php echo $row["User_Position_HireDate"]; ?>
										...
										<?php echo "</td></tr><tr><th>Effdt:</th><td>";?><?php echo $row["User_Effdt"]; ?>  
								<?php echo "</td></tr>";?>
                                <?php echo "</thead>";?>
                                <?php echo "<tbody>";?>
								<?php echo "</tbody>";?>                            
