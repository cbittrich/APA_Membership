...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql = "INSERT INTO User_Admin (user_admin_effdt, id) VALUES (now(), ?)";
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        if(mysqli_stmt_execute($stmt)){
            ...
            header("location: ViewAdminRoster.php");
            exit();
        } else{
...
<head>
    <meta charset="UTF-8">
    <title>APA - Delegate Admin</title>
...
<head>
    <meta charset="UTF-8">
    <title>APA - Terminate Admin</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <style>
        .wrapper{
            width: 600px;
...
<body>
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5 mb-3">Delegate Admin:</h2>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            <input type="hidden" name="id" value="<?php echo trim($_GET["id"]); ?>"/>
                            <p>Are you sure you want to grant this account Admin access?</p>
                            <p>
                                <input type="submit" value="Yes" class="btn btn-danger">
                                <a href="ViewAdminRoster.php" class="btn btn-secondary">No</a>
                            </p>
                        </div>
                    </form>
                </div>
