...
<br>Your username is: <?php echo htmlspecialchars($_SESSION["username"]); ?>
	 ...
	 <br>
		...
		<table style="width:auto" class="center">
                <tr><td><li>
        <a href="RegisterNewUser.php" title="Add Employee to Roster">Add Employee to Roster</a>              </li></td></tr> 
                <tr><td><li> 
        ...
        <a href="ViewMembershipRoster.php"  class="is-active">Update Membership Status</a>
			  			        ...
			  			        <tr><td><li>
        <a href="ViewMembershipAddress.php" title="Update Membership Address">Update Membership Address</a>
  
              </li></td></tr>
			  
			  			  			        <tr><td><li>
        <a href="ViewAdminRoster.php" title="Delegate/Remove Admin Status">Delegate/Remove Admin Status</a>
