...
<br>Your username is: <?php echo htmlspecialchars($_SESSION["username"]); ?>
   ...
   <!-- <nav role="navigation" aria-labelledby="block-rtf-main-menu-menu" id="block-rtf-main-menu" class="block block-menu navigation menu--main">-->
            
  <h2 class="visually-hidden" id="block-rtf-main-menu-menu">Admin Services</h2>
  

        
     <ul class="menu">
				  	   <li class="menu-item">
        <a href="RegisterNewUser.php" title="Add Employee to Roster">Add Employee to Roster</a>
  
              </li>
			   <li class="menu-item">
        <a href="ViewEmployeeRoster.php"  class="is-active">View/Edit Employee Roster</a>
              </li>
                    <li class="menu-item">
        <a href="ViewMembershipRoster.php"  class="is-active">Update Membership Status</a>
              </li>
			
                <li class="menu-item">
        <a href="/" title="Update Member Address Information">Update Member Address Information</a>
				  </li>
				  	   <li class="menu-item">
        <a href="/who-we-are" title="Update Address">Delegate/Remove Admin Status</a>
